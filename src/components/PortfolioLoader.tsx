...
export default function PortfolioLoader({ onComplete }: PortfolioLoaderProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#050508] flex items-center justify-center overflow-hidden select-none">
      <style>{`
        @keyframes blink {
          0%, 100% { opacity: 0 }
          50% { opacity: 1 }
      ...
      <motion.div
        ...
        className="relative max-w-[440px] w-[92%] p-5 md:p-6 rounded-2xl border border-[#FACC15]/20 bg-[#0b0b0d]/80 backdrop-blur-xl shadow-[0_0_50px_rgba(250,204,21,0.06),inset_0_0_20px_rgba(255,255,255,0.01)] flex flex-col"
      >
        ...
        <div className="relative w-44 h-44 mx-auto flex items-center justify-center mb-6 shrink-0">
          ...
          <div className="w-[88%] h-[88%] rounded-full border border-[#FACC15]/25 bg-[#040405] p-1 flex items-center justify-center relative overflow-hidden">
