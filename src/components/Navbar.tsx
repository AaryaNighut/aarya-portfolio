...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[9999] w-full bg-[#0b0b0d]/75 backdrop-blur-[18px] border-b border-white/[0.05] select-none h-14 lg:h-16 flex items-center transition-all duration-300">
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-14 lg:top-16 z-[9998] mx-4 p-6 bg-[#0b0b0d]/95 border border-white/[0.08] backdrop-blur-2xl rounded-2xl shadow-2xl lg:hidden flex flex-col gap-4 select-none"
          >
