      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 w-full flex flex-col items-center gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-12 items-center lg:items-stretch w-full relative z-10 mt-2">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between gap-6 h-full">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                {/* Location Card */}
                <div className="flex items-center gap-4 group p-4 rounded-2xl border border-white/[0.08] hover:border-[#FACC15] bg-[#0f1b35]/85 hover:bg-[#0f1b35] hover:shadow-[0_0_20px_rgba(234,179,8,0.05)] transition-all duration-500 ease-out hover:-translate-y-0.5">
                  <div className="p-2.5 rounded-xl bg-[#1e355e] border border-white/[0.05] text-yellow-500 group-hover:border-yellow-500/20 group-hover:scale-105 transition-all duration-300">
                ...
                <a
                  ...
                  className="flex items-center gap-4 group p-4 rounded-2xl border border-white/[0.08] hover:border-[#FACC15] bg-[#0f1b35]/85 hover:bg-[#0f1b35] hover:shadow-[0_0_20px_rgba(234,179,8,0.05)] transition-all duration-500 ease-out hover:-translate-y-0.5 cursor-pointer"
                >
                  <div className="p-2.5 rounded-xl bg-[#1e355e] border border-white/[0.05] text-yellow-500 group-hover:border-yellow-500/20 group-hover:scale-105 transition-all duration-300">
                ...
                {socials.map((soc, idx) => {
                  ...
                  return (
                    <a
                      ...
                      className="p-3 rounded-2xl border border-white/[0.04] bg-white/[0.01] hover:bg-[#1e355e] hover:border-yellow-500/30 text-slate-400 hover:text-yellow-500 hover:scale-105 transition-all duration-300 hover:shadow-[0_0_15px_rgba(234,179,8,0.1)] flex items-center justify-center cursor-pointer group"
                      title={soc.label}
                    >
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            <div className="relative p-6 md:p-8 rounded-[24px] border border-white/[0.08] bg-gradient-to-b from-[#0f1b35]/90 to-[#0f1b35]/75 backdrop-blur-xl shadow-2xl overflow-hidden">
              ...
              <form noValidate action="https://formsubmit.co/aaryanighut07@gmail.com" method="POST" onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="px-4 py-2.5 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.04] focus:bg-[#1e355e] text-xs text-white focus:outline-none focus:border-yellow-500/40 focus:ring-1 focus:ring-yellow-500/20 transition-all duration-300 placeholder:text-slate-600"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="px-4 py-2.5 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.04] focus:bg-[#1e355e] text-xs text-white focus:outline-none focus:border-yellow-500/40 focus:ring-1 focus:ring-yellow-500/20 transition-all duration-300 resize-none placeholder:text-slate-600"
