              ...
              <form noValidate action="https://formsubmit.co/aaryanighut07@gmail.com" method="POST" onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="px-4 py-2.5 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.04] focus:bg-[#152342] text-xs text-white focus:outline-none focus:border-yellow-500/40 focus:ring-1 focus:ring-yellow-500/20 transition-all duration-300 placeholder:text-slate-600"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="px-4 py-2.5 rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.04] focus:bg-[#152342] text-xs text-white focus:outline-none focus:border-yellow-500/40 focus:ring-1 focus:ring-yellow-500/20 transition-all duration-300 resize-none placeholder:text-slate-600"
