        ...
        >
          ...
          <div className="flex flex-nowrap justify-start items-center gap-[14px] w-full md:w-max select-none overflow-x-auto scrollbar-none pt-3 pb-2 mb-[16px]">
            {[
              ...
              <div
                key={tech.name}
                className={`flex flex-col items-center justify-center w-[72px] h-[82px] rounded-xl border border-white/[0.08] bg-[#050c1e]/75 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 group flex-shrink-0 ${tech.hoverGlow}`}
              >
          ...
          <div className="max-w-xl w-full py-4.5 px-6 rounded-2xl border border-white/[0.05] bg-[#050c1e]/40 hover:bg-[#050c1e]/60 hover:border-yellow-500/20 backdrop-blur-md shadow-xl transition-all duration-300 grid grid-cols-2 md:grid-cols-4 gap-4 mb-[22px] hover:shadow-[0_0_35px_rgba(250,204,21,0.03)]">
            {stats.map((stat, idx) => (
