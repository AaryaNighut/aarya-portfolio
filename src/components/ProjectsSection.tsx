          ...
          {!loading && projects.length > 0 && (
            <>
              {showLeftArrow && (
                <button
                  onClick={() => scroll("left")}
                  className="hidden md:flex absolute -left-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-[#050c1e]/90 border border-white/[0.08] hover:border-yellow-500/30 text-white hover:bg-[#050c1e] hover:scale-105 hover:shadow-[0_0_15px_rgba(255, 212, 0, 0.15)] transition-all duration-300 shadow-xl cursor-pointer"
              ...
              {showRightArrow && (
                <button
                  ...
                  className="hidden md:flex absolute -right-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-[#050c1e]/90 border border-white/[0.08] hover:border-yellow-500/30 text-white hover:bg-[#050c1e] hover:scale-105 hover:shadow-[0_0_15px_rgba(255, 212, 0, 0.15)] transition-all duration-300 shadow-xl cursor-pointer"
                  title="Next Project"
                >
...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4 mb-4 shrink-0 relative z-20">
        ...
        <div className="flex flex-col gap-1.5 shrink-0 select-none">
          <a
            ...
            className="flex items-center justify-between gap-1 px-3 py-1 rounded-full border border-white/[0.08] hover:border-yellow-500/30 bg-[#152342] hover:bg-white/[0.06] text-[8px] font-bold text-slate-300 hover:text-white transition-all duration-300 uppercase tracking-widest cursor-pointer"
          >
            <span>GITHUB</span>
      ...
      <div className="relative w-full h-[140px] sm:h-[160px] md:h-[180px] rounded-xl overflow-hidden bg-[#040815] border border-white/[0.06] select-none shrink-0 z-20">
        <motion.img
          key={currentIdx}
          ...
          className="object-contain w-full h-full bg-[#152342]/75 group-hover:scale-[1.04] transition-transform duration-700 ease-out"
        />
        
        <div className="absolute inset-0 bg-gradient-to-t from-[#152342]/30 via-transparent to-transparent pointer-events-none" />
