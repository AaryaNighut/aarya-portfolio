            ...
            return (
              <motion.div
                ...
                transition={{
                 ...
                 className="group relative p-6 rounded-2xl border border-white/[0.06] bg-[#0f172a]/60 backdrop-blur-md hover:bg-[#0f172a]/80 hover:border-[#FACC15]/40 hover:shadow-[0_15px_40px_-10px_rgba(250,204,21,0.08)] transition-all duration-300 ease-out cursor-default flex flex-col justify-between w-full sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] flex-grow-0 flex-shrink-0 min-h-[260px]"
              >
                {/* Glow Border Overlay */}
                ...
                <div className="absolute top-0 inset-x-0 h-[1.5px] bg-gradient-to-r from-yellow-500/0 via-yellow-500/30 to-yellow-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {category.skills.map((skill) => (
                        <motion.span
                          ...
                          className="inline-flex items-center px-3 py-1 rounded-lg bg-white/[0.02] border border-white/[0.05] hover:bg-yellow-400/10 hover:border-yellow-400/30 hover:text-yellow-400 text-[11.5px] font-semibold text-slate-400 transition-all duration-200 cursor-default select-none"
                        >
                          {skill}
                        </motion.span>
                      ))}
